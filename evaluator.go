...
//           doSomething(&x)
//       }
// The rationale is the same as above, and is safe as long as the same conditions apply. Since
// Go 1.22, each iteration has its own variable, so this needs no linter suppression.
